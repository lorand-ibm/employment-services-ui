...
export const reveal = ({name}) => WrappedComponent => {
  class RevealOverlay extends Component {
    ...
    render() {
      ...
      // Set z-index higher than in our form modals. See src/modal/_modal.scss.
      // Otherwise these error messages won't be visible because they're covered
      // by the form modal.
      // @todo Create a better solution for handling z-indexes.
      const zIndex = 999999;
      ...
      const style = {display: revealState.isOpen ? 'block' : 'none', zIndex};
