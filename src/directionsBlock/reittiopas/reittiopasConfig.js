...
const reittiopasConfig = {
  ...
  urlTransportModes: {
    WALK: 'WALK',
    BICYCLE: 'BICYCLE',
    ALL: 'BUS,TRAM,CRAIL,SUBWAY,FERRY,PUBLIC_TRANSPORT',
    CAR: 'CAR_PARK',
  },
};

export default reittiopasConfig;
